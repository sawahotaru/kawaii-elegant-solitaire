...
export const Card: React.FC<CardProps> = ({
    ...
    if (!card.isFaceUp) {
        return (
            <motion.div
                ...
                onClick={onClick}
                className={`w-14 sm:w-20 h-20 sm:h-28 rounded-xl border-2 border-white shadow-md cursor-pointer bg-gradient-to-br from-pink-200 to-lavender-200 relative overflow-hidden ${className}`}
    ...
    return (
        <motion.div
            ...
            onClick={onClick}
            className={`
        w-14 sm:w-20 h-20 sm:h-28 rounded-xl border-[1px] border-gray-100 shadow-md cursor-grab active:cursor-grabbing
